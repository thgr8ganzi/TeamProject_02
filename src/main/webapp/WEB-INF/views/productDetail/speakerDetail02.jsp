            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">BeoSound Edge 블루투스 스피커</h1>
                        ...
                        <!-- 제품 설명란 -->
                        <p class="lead">Beosound Edge는 스피커와 미니멀리즘 디자인 작품이 하나로 융화된 모습을 하고 있으며, 직관적인 터치와 모션 기능에 더하여 그 모습만큼이나 선명한 오디오와 아름다움의 완전한 조화를 자랑합니다.</p>
                        
                        <div class="d-flex">
                            <c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('1','BeoSound Edge 블루투스 스피커', '${id}','speaker/detail/speakerDetail02-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-success flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','BeoSound Edge 블루투스 스피커', '${id}','speaker/detail/speakerDetail02-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
