            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/speaker/detail/speakerDetail07-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail07-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail07-02.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail07-03.jpg" class="d-block" style="width:100%">
						    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">뱅앤올룹슨 베오사운드 1 블루투스 스피커</h1>
                        ...
                        <!-- 제품 설명란 -->
                        <p class="lead">맞춤형으로 제작된 풀레인지 드라이버는 리플렉터 안에서 아래쪽으로 재생되고, 사운드 방향과 스피커 구조의 조합으로 구형 사운드를 만들어, 모든 방향에서 일관된 음색을 경험할 수 있습니다.</p>
                        
                        <div class="d-flex">
                            <c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('1','뱅앤올룹슨 베오사운드 1 블루투스 스피커', '${id}','speaker/detail/speakerDetail07-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-success flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','뱅앤올룹슨 베오사운드 1 블루투스 스피커', '${id}','speaker/detail/speakerDetail07-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
