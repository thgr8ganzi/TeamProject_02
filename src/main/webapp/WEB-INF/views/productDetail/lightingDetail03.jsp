            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/lighting/detail/lightingDetail03-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail03-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail03-02.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail03-03.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail03-04.jpg" class="d-block" style="width:100%">
						    </div>
						  </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">Noctambule Suspension Cylinder(6 High)</h1>
                        
                        <!-- 제품 가격 -->
                        <div class="fs-5 mb-5">
                            <span>시장 판매가 : 14,670,000원</span>
                        </div>
                        
                        <!-- 제품 설명란 -->
                        <p class="lead">디자이너 Konstantin Grcic이 올빼미에게서 영감을 얻어 제작한 Noctambule 조명입니다. 낮에는 실내 장식처럼 공간과 조화롭게 어우러지다가, 밤에는 밝게 빛나며 존재를 드러냅니다. 투명한 유리 실린더 바디가 특징이며 밤과 낮 모두 아름답게 감상할 수 있습니다.</p>
                        
                        <div class="d-flex">
                        	<c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('3','Noctambule Suspension Cylinder(6 High)', '${id}','lighting/detail/lightingDetail03-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('3','Noctambule Suspension Cylinder(6 High)', '${id}','lighting/detail/lightingDetail03-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
