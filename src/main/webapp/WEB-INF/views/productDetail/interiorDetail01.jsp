            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/interior/detail/interiorDetail01-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/interior/detail/interiorDetail01-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/interior/detail/interiorDetail01-02.jpg" class="d-block" style="width:100%">
						    </div>
						  </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">윌리엄 3 - 시터 소파 W266</h1>
                        
                        <!-- 제품 가격 -->
                        <div class="fs-5 mb-5">
                            <span>시장 판매가 : 16,864,000</span>
                        </div>
                        
                        <!-- 제품 설명란 -->
                        <p class="lead">L. 266cm - P.90cm - H.87cm</p>
                        
                        <div class="d-flex">
                        	<c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('3','윌리엄 3 - 시터 소파 W266', '${id}','interior/detail/interiorDetail01-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('3','윌리엄 3 - 시터 소파 W266', '${id}','interior/detail/interiorDetail01-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
