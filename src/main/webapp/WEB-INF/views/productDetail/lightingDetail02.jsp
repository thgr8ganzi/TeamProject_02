            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/lighting/detail/lightingDetail02-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail02-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail02-02.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/lighting/detail/lightingDetail02-03.jpg" class="d-block" style="width:100%">
						    </div>
						  </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">Taraxacum 88 S2 Pendant LED</h1>
                        
                        <!-- 제품 가격 -->
                        <div class="fs-5 mb-5">
                            <span>시장 판매가 : 17,691,010원</span>
                        </div>
                        ...
                        <div class="d-flex">
                        	<c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('3','Taraxacum 88 S2 Pendant LED', '${id}','lighting/detail/lightingDetail02-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-dark flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('3','Taraxacum 88 S2 Pendant LED', '${id}','lighting/detail/lightingDetail02-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
