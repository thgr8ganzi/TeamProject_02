            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/speaker/detail/speakerDetail06-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail06-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail06-02.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail06-03.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail06-04.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail06-05.jpg" class="d-block" style="width:100%">
						    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- 제품 이름 -->
                        <h1 class="display-5 fw-bolder">블루투스 스피커 배오사운드 밸런스</h1>
                        ...
                        <!-- 제품 설명란 -->
                        <p class="lead">7개의 드라이버로 구서된 독특한 음향 시스템을 갖춘 Beosound Balance는 사용자가 원할 때 강력한 저음과 진정한 룸 필링 사운드를 위한 폭넓은 사운드 이미지를 출력할 수 있도록 설계되었습니다.</p>
                        
                        <div class="d-flex">
                            <c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('1','블루투스 스피커 배오사운드 밸런스', '${id}','speaker/detail/speakerDetail06-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-success flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','블루투스 스피커 배오사운드 밸런스', '${id}','speaker/detail/speakerDetail06-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="badge bg-success text-white position-absolute" style="top: 0.5rem; right: 0.5rem;">Basic</div>
                            <!-- 제품 이미지-->
                            <img class="card-img-top" src="images/speaker/speakerMain05.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- 관련 제품 이름-->
                                    <h5 class="fw-bolder">블루투스 스피커 배오사운드 밸런스</h5>
                                    <!-- 제품 추천(별 개수)-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="speakerDetail05">View options</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="badge bg-success text-white position-absolute" style="top: 0.5rem; right: 0.5rem;">Basic</div>
                            <!-- 제품 이미지-->
                            <img class="card-img-top" src="images/speaker/speakerMain07.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- 관련 제품 이름-->
                                    <h5 class="fw-bolder">뱅앤올룹슨 베오사운드 1 블루투스 스피커</h5>
                                    <!-- 제품 추천(별 개수)-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="speakerDetail07">View options</a></div>
                            </div>
                        </div>
                    </div>
