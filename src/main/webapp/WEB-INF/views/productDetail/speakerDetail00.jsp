            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="images/speaker/detail/speakerDetail00-00.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail00-01.jpg" class="d-block" style="width:100%">
						    </div>
						    <div class="carousel-item">
						      <img src="images/speaker/detail/speakerDetail00-02.jpg" class="d-block" style="width:100%">
						    </div>
						  </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
	                        <c:if test="${id!=null&&id.trim().length()!=0}">
	                        	<button class="btn btn-outline-danger flex-shrink-0" type="submit" style="max-width: 10rem;" onclick="wish('1','A9 4세대 블루투스스피커_Smoked Oak', '${id}','speaker/detail/speakerDetail00-00')"><i class="bi bi-heart"></i> 
		                        	관심등록하기
		                        </button>&nbsp;&nbsp;&nbsp;
		                        <button class="btn btn-outline-success flex-shrink-0" type="submit" style="max-width: 10rem" onclick="choice('1','A9 4세대 블루투스스피커_Smoked Oak', '${id}','speaker/detail/speakerDetail00-00')">
		                        &nbsp;구독하기&nbsp;
		                        </button>
		                	</c:if>
		                	<c:if test="${id==null||id.trim().length()==0}">
